...
public class ComUtils
{
  ...
  */
  ...
  /*
  to write/read in a file
  */
   public ComUtils(String fileName) throws IOException
  {
   ...
   /*
   use to filter space chars at the beginning or end of a instruction
   */
  public char SpaceFilter() throws IOException{
      char s = ' ';
      while (s == ' '){
        if (this.dis.available() == 0){
            return ' ';
        }
        s = (char) this.dis.readByte();
    }
    return s;
  }
  ...
  public String readString(int s) throws IOException
  {
    String str;
    byte bStr[] = new byte[s];
  ...
  /* Escriure un string */
  public void write_string(String str,int l) throws IOException
  { 
    int numBytes, lenStr; 
    byte bStr[] = new byte[l];
  ...
  public byte[] read_bytes(int numBytes) throws IOException{
    ...
    /*
    to know byte available to be readed
    */
    ...
    public void flush() throws IOException {
        this.read_bytes(this.dis.available());
    }
