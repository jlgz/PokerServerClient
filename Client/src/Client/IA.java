...
public class IA {
     ...
     * @return ArrayList of the cards to swap (randomly) from the hand with the deck
     */
     ...
     * @param money player money left
     * @return Command of the action to make (bet_, rise, call, pass, fold)
     */
    public ArrayList<String> getSmartBetAction(int rank, int p1_bet, int p2_bet, int money) {
        ...
        if (rank == 9 || rank == 8 || rank == 7 || rank == 6) {
            ...
            if (p1_bet == p2_bet) {
                ...
                bet = (int) ((int) money*ratio/4 - rn.nextInt((int) money/4));
                bet_action.add("bet_");
            ...
            // else, p2 has made a bet, we "rise" the bet if we can, else we "bet_" or "call"
                ...
                // else (bet < money), we "rise"
                    ...
                    money = money - bet_diff;
                    bet = bet_diff + ((int) money*ratio/4 - rn.nextInt((int) money/4));
                    bet_action.add("rise");
        ...
        // we have a normal hand! --> "bet_" or "rise" if possible, if not "call"
            ...
            if (p1_bet == p2_bet) {
                ...
                // else, we "bet_"
                    ...
                    // bet = money*( 1/10, 2/10]
                    bet = (int) ((int) money/5 - rn.nextInt((int) money/10));
                    bet_action.add("bet_");
                    bet_action.add(Integer.toString(bet));
                    return bet_action;
                }
            ...
            // else, p2 has made a bet, we may "rise" the bet or "call"
                ...
                // else (bet < money), we may "rise" or "call", low probability to "fold"
                    ...
                    money = money - bet_diff;
                    bet = bet_diff + ((int) money/5 - rn.nextInt((int) money/10));
                    ...
                    } else if (bet_diff >= p1_bet && money/3 > bet_diff) {
        ...
        // we have a "bad-ish" hand! --> may "bet_" or "rise", if not "call" or "fold"
            ...
            if (p1_bet == p2_bet) {
                ...
                if (pass < 10) {
                    ...
                    bet = (int) money*ratio/4 - rn.nextInt((int) money/4);
                    bet_action.add("bet_");
                    bet_action.add(Integer.toString(bet));
                    return bet_action;
                }
                ...
                // else, we "bet_"
                    ...
                    // bet = money*( 1/18, 3/18]
                    bet = (int) ((int) money/6 - rn.nextInt((int) money/9));
                    bet_action.add("bet_");
                    bet_action.add(Integer.toString(bet));
                    return bet_action;
                }
            ...
            // else, p2 has made a bet, we may "rise" the bet or "call"
                ...
                // else (bet < money), we may "rise" or "call", low probability to "fold"
                    ...
                    money = money - bet_diff;
                    bet = bet_diff + ((int) money/6 - rn.nextInt((int) money/9));
                    ...
                    } else if (bet_diff >= p1_bet/2 && money/3 > bet_diff) {
                        // random number to "rise"
                        int rise = rn.nextInt(100);
